...
```bash
wget https://github.com/hardenedpenguin/sayip-reboot-halt-saypublicip/releases/download/v1.0.8-2/sayip-node-utils_1.0.8-2_all.deb
sudo NODE_NUMBER=12345 dpkg -i sayip-node-utils_1.0.8-2_all.deb
```
...
```bash
sudo NODE_NUMBER=NEW_NODE_NUMBER dpkg -i sayip-node-utils_1.0.8-2_all.deb
```
