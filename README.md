...
```bash
wget https://github.com/hardenedpenguin/sayip-reboot-halt-saypublicip/releases/download/v1.0.7/sayip-node-utils_1.0.7-1_all.deb
sudo NODE_NUMBER=12345 dpkg -i sayip-node-utils_1.0.7-1_all.deb
```
...
```bash
sudo NODE_NUMBER=NEW_NODE_NUMBER dpkg -i sayip-node-utils_1.0.7-1_all.deb
```
